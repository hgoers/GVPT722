...
@appel2012 (two wonderful UMD alumni) explore the determinants of foreign direct investment (FDI) flows into and out of post-conflict states. States that are emerging from civil war often have an acute need for foreign and stable sources of capital. However, multinational corporations and other foreign commercial actors are likely to view post-conflict states as relative high risk countries in which to invest: the risk of a return to violence and instability is often high in the immediate aftermath of a civil war. Understanding this, leaders of post-conflict states often attempt to decrease this perception of risk. 

Appel and Loyle argue that leaders can successfully do this by establishing post-conflict justice (PCJ) institutions. These institutions impose both domestic and reputational costs on post-conflict leaders. This cost allows leaders to signal to foreign commercial actors of their commitment to minimizing the risk of a return to violence and instability. This is a great paper and I encourage you to take a look at [their argument](https://journals.sagepub.com/doi/10.1177/0022343312450044) in detail if this interests you. 

If their argument is correct, we should observe higher levels of FDI investment coming into post-conflict states that establish PCJ institutions than those that do not, on average and holding all else constant. In other words, if we have two identical post-conflict states (same economic conditions, same political conditions) foreign commerical actors should have the same beliefs about their risk of returning to conflict (and; therefore, their attractiveness as investment destinations). However, if one of these states has established PCJ institutions and the other has not, we expect those same foreign commercial actors to believe that the risk the former state will return to violence and instability is less than that of the latter. We cannot observe these actors' beliefs about this risk. Rather, we can observe the consequence of those different beliefs: FDI inflows. 

Appel and Loyle find strong empirical evidence that post-conflict states that establish PCJ institutions receive substantially more FDI than states that do not. We will replicate and extend this empirical work. In doing so, we will become more familiar with the underlying mechanics of multiple linear regression and strengthen our ability to interpret these models. 
...
## Relationship between PCJ institutions and net FDI 
...
Therefore, I hypothesize that the greater a state's GDP per capita, the larger its net FDI inflows. 
